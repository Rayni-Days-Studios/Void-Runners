...
public class ConnectAndJoinRandom : Photon.MonoBehaviour
{
    ...
    {
        if (PhotonNetwork.networkingPeer.AvailableRegions != null) Debug.LogWarning("rist of available regions counts " + PhotonNetwork.networkingPeer.AvailableRegions.Count + ". First: " + PhotonNetwork.networkingPeer.AvailableRegions[0] + " \t Current Region: " + PhotonNetwork.networkingPeer.CloudRegion);
